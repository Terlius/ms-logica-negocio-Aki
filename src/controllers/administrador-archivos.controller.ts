...
export class AdministradorArchivosController {
  constructor() {}
  ...
  async cargarArchivoProducto(
    ...
    const filePath = path.join(parentDir, GeneralConfig.carpetaArchivosProductos);
  ...
  private obtenerArchivosTipo(tipo: number) {
    ...
    switch (tipo) {
      ...
      case 1:
        ...
        filePath = path.join(parentDir, GeneralConfig.carpetaArchivosProductos);

        break;
      case 2:
        filePath = path.join(parentDir, GeneralConfig.carpetaArchivosClientes);
      case 3:
        break;
    }
    return filePath;
